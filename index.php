...
the_post_thumbnail();
        ...
        <header class="entry-header">
            ...
            <p class="entry-meta"><?php the_time('l, F d, Y'); ?> | <?php echo get_the_term_list( $post->ID, 'byfandom', 'Fandoms: ', ', ' ); ?> | <a href="<?php comments_link(); ?>"><?php comments_number(); ?></a> | <?php edit_post_link(); ?></p></header>
